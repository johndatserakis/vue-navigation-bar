...
| tooltipAnimationType                     | String      | no       | 'fade'            | 'shift-away', 'shift-toward', 'fade', 'scale', 'perspective' | See [tippy.js docs](https://atomiks.github.io/tippyjs/all-options/). If you're using any option other than `shift-away`, then you'll need to make sure to import that `css` from `tippy.js`.                                                                                                                                                                                                                   |
