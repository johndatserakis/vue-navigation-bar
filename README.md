...
| collapseButtonColor                 | String       | no       | `#373737`      |                                                              | CSS hex - `#FFF`                                                                                                                                                                                                                                                           |
| popupCloseButtonColor                 | String       | no       | `#373737`      |                                                              | CSS hex - `#FFF`                                                                                                                                                                                                                                                           |
...
| tooltipAnimationType                     | String      | no       | 'shift-away'            | 'shift-away', 'shift-toward', 'scale', 'perspective' | See [tippy.js docs](https://atomiks.github.io/tippyjs/all-options/). If you're using any option other than `shift-away`, then you'll need to make sure to import that `css` from `tippy.js`.                                                                                                                                                                                                                   |
